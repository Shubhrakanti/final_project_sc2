...
class ConvLstm(base_agent.BaseAgent):
    """A conv lstm model."""
    ...
    def _build(self):
        ...
        with tf.variable_scope(self.name):
            ...
            """LSTM state"""
            self.c = tf.placeholder(tf.float32, [None, lstm_size], name="lstm_c")
            
            self.h = tf.placeholder(tf.float32, [None, lstm_size], name="lstm_h")
